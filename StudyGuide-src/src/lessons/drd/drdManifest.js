...
export const DRD_LESSONS = [
  ...
  },
  {
    ...
    summary: "Heatmaps, gene/sample clustering, outliers, PCA-like reasoning and linking patterns to phenotype, treatment, tissue or batch.",
  ...
  },
  {
    ...
    summary: "Bulk versus single-cell RNA-seq, cellular heterogeneity, counts/UMIs, marker genes, dimensionality reduction, clustering and dropout-aware interpretation.",
    tags: ["scRNA-seq", "UMI", "markers", "UMAP"],
    products: ["bulk/single-cell comparison", "glossary", "simulated prompt"],
    lessonType: "planned",
  ...
  },
  {
    ...
    summary: "Batch effect detection/correction, ComBat, PCA before/after correction, heatmaps, clustering and final verification-test integration.",
