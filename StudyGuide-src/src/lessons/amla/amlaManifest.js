...
export const AMLA_LESSONS = [
  ...
  },
  {
    ...
    resources: {
      slides: "https://drive.google.com/file/d/1KH42rcyEu6FZDd91nD1mAuWiSaTzE9dl/view?usp=drivesdk",
      transcript: transcripts["2026-04-20"],
      recording: recordings["2026-04-20"],
      notebook: { todo: "Transcript/slide 36 mention MNIST 2 Part A and `..._HandsOn_Tensors.ipynb`, but the extracted sources did not expose a standalone Colab/Drive URL." },
    },
    aliases: ["03", "l03", "mlp-training", "backpropagation", "tensors"],
