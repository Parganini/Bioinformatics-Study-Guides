...
export const AMLA_LESSONS = [
  ...
  },
  {
    ...
    summary: "Content pending. The transcript continues the Keras/MNIST hands-on flow around the Module 2 Lecture2_tmp material rather than introducing a separate dated Module 1 lecture deck.",
    tags: ["Keras", "MNIST", "hands-on", "exam context"],
    lessonType: "hands-on continuation",
    products: ["placeholder", "shared resources linked"],
    resources: {
      slides: "https://drive.google.com/file/d/10FvZXY58dUeHgllfvJmAG4bFqsyao5OG/view?usp=drivesdk",
  ...
  },
  {
    ...
    date: "2026-04-23",
    status: "todo",
    title: "Neural-network representation and formalism",
    summary: "Content pending. Module 1 Lecture2 matches this transcript: neural-network notation, layers, activations, weights and the formal representation of feed-forward models.",
    tags: ["neural networks", "representation", "weights", "activations"],
    lessonType: "theory",
    products: ["placeholder", "resources linked"],
    resources: { slides: "https://drive.google.com/file/d/1lr5UIh_hYDwRNs33PO7_Sm40Rc_X7SF-/view?usp=drivesdk", transcript: transcripts["2026-04-23"], recording: recordings["2026-04-23"], notebook: null },
    aliases: ["04", "l04"],
  ...
  },
  {
    ...
    summary: "Content pending. Module 1 Lecture4 matches this class and introduces convolutional neural networks for image-oriented deep learning.",
    tags: ["CNN", "convolution", "vision"],
    lessonType: "theory + practice",
    products: ["placeholder", "resources linked"],
    resources: { slides: "https://drive.google.com/file/d/1mXJV9hVkWTujLZcENm2HJ-d5yLzl6yMc/view?usp=drivesdk", transcript: transcripts["2026-05-08"], recording: recordings["2026-05-08"], notebook: null },
    aliases: ["06", "l06"],
