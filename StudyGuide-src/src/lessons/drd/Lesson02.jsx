...
function LessonNav({ lang = "es", position = "top", isDone = false, toggle = () => {}, copy }) {
  ...
  return <M1LessonNav lessonId="m1-stanford" labels={{ ...nav, done: copy.done, mark: copy.mark }} isDone={isDone} toggle={toggle} position={position} previousHref="#/lesson/m1-foundations" nextHref="#/lesson/m1-affy" />;
}
