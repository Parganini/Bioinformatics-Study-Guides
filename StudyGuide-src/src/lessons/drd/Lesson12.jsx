...
function LessonNav({ lang, isDone, toggle, bottom = false }) {
  const labels = ui[lang] || ui.es;
  return <DRDLessonNav labels={labels} isDone={isDone} toggle={toggle} bottom={bottom} previousHref="#/lesson/m2-normalization-1" nextHref="#/lesson/m2-dmp-dmr" />;
}
