...
const UI = {
  en: {
    ...
    drdDesc: "Course map for Module 1 theory and Module 2 methylation-array pipelines, updated with the May 27 status and upcoming topics.",
  ...
  es: {
    ...
    drd: "DNA/RNA Dynamics",
    drdDesc: "Mapa de la materia con Module 1 teórico y Module 2 de pipelines de metilación, actualizado al 27 de mayo e incluyendo los temas pendientes.",
  ...
  fa: {
    ...
    drd: "DNA/RNA Dynamics",
    drdDesc: "نقشهٔ درس برای ماژول ۱ نظری و ماژول ۲ پایپ‌لاین‌های methylation array، با وضعیت ۲۷ مه و موضوعات آینده.",
