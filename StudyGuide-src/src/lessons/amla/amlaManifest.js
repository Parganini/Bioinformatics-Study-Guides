...
export const AMLA_LESSONS = [
  ...
  },
  {
    ...
    date: "2026-05-14",
    status: "available",
    title: "Autoencoders, SVMs and dimensionality reduction",
    summary: "A long class covering efficient representations, autoencoder architecture and MNIST reconstruction, denoising/sparse/convolutional AEs, SVM margin and kernel intuition, and dimensionality reduction with PCA plus a glance at manifold learning.",
    tags: ["autoencoders", "latent space", "denoising", "SVM", "kernel trick", "PCA", "dimensionality reduction"],
    lessonType: "theory + multiple mini-labs",
    products: ["source-based lesson", "static-slide walkthrough", "AE/SVM/PCA interaction", "exam-style MCQs"],
    resources: {
      slides: "https://drive.google.com/file/d/1wy_48Rhs_ABO3WGRN6L2pJAFgXRvP5xz/view?usp=drivesdk",
      transcript: transcripts["2026-05-14"],
      recording: recordings["2026-05-14"],
      notebook: { todo: "Slides name `..._HandsOn_AE.ipynb` and `_HandsOn_SVM.ipynb`, but the extracted sources did not expose standalone Colab/Drive URLs." },
    },
    aliases: ["07", "l07", "autoencoders", "svm", "pca"],
  ...
  },
  {
    ...
    summary: "Voting, bagging/pasting, random forests, boosting, XGBoost and stacking as reference; Module 2 Lecture0 remains linked as a short complementary setup deck not covered as the main class content.",
    tags: ["ensemble learning", "voting", "bagging", "random forest", "boosting", "XGBoost", "stacking"],
    lessonType: "theory + ensemble mini-labs",
    products: ["source-based lesson", "static-slide walkthrough", "ensemble sorter interaction", "exam-style MCQs"],
    resources: {
      slides: "https://drive.google.com/file/d/1T8JbT2riAu7GC9v5D0VXxYDp1aFZ5aaD/view?usp=drivesdk",
      extraSlides: "https://drive.google.com/file/d/1jUiL9kL09mt3kdmnwII7lCsyV4gHCx61/view?usp=drivesdk",
      transcript: transcripts["2026-05-15"],
      recording: recordings["2026-05-15"],
      notebook: { todo: "Slide 41 names `..HandsOn_Ensemble.ipynb`, but the extracted sources did not expose a standalone Colab/Drive URL." },
    },
    aliases: ["08", "l08", "ensemble", "boosting", "random-forest"],
  ...
  },
  {
    ...
    summary: "Object counting strategies, Fluocells data peculiarities, EDA, thresholding baseline, semantic segmentation foundations and project-oriented evaluation.",
    tags: ["object recognition", "counting", "fluocells", "segmentation", "thresholding", "baseline"],
    lessonType: "theory + guided hands-on",
    products: ["source-based lesson", "static-slide walkthrough", "EDA mini-lab", "thresholding baseline mini-lab", "exam-style MCQs"],
    resources: {
    ...
    aliases: ["09", "l09", "fluocells", "object-counting", "thresholding-baseline"],
  ...
  },
  {
    ...
    summary: "Semantic segmentation for Fluocells, U-Net/c-ResUNet architecture, PyTorch/FastAI DataLoaders and Learner, augmentation, losses, callbacks and performance assessment.",
    tags: ["semantic segmentation", "c-ResUNet", "FastAI", "data augmentation", "Dice loss", "training loop"],
    lessonType: "theory + guided hands-on",
    products: ["source-based lesson", "static-slide walkthrough", "architecture mini-lab", "augmentation mini-lab", "training-loop mini-lab", "exam-style MCQs"],
    resources: {
    ...
    aliases: ["10", "l10", "semantic-segmentation", "cresunet", "fastai", "dice-loss"],
  ...
  },
  {
    ...
    summary: "Project interpretation expectations, interpretability versus explainability, feature importance, SHAP/Shapley values, LIME local surrogates and XAI pitfalls.",
    tags: ["XAI", "SHAP", "LIME", "interpretability", "feature importance", "bias"],
    lessonType: "theory + mini-lab",
    products: ["source-based lesson", "static-slide walkthrough", "SHAP mini-lab", "LIME comparison mini-lab", "exam-style MCQs"],
    resources: {
    ...
    aliases: ["11", "l11", "xai", "shap", "lime", "explainability"],
  ...
  },
  {
    ...
    summary: "Final project guidance plus a broad advanced-topic wrap-up: RNNs, BPTT, time-series forecasting, long-sequence problems, LSTM/GRU, transformers/LLMs, VAEs and GANs.",
    tags: ["final class", "project", "RNN", "LSTM", "GRU", "transformers", "GAN", "VAE"],
    lessonType: "project briefing + theory",
    products: ["source-based lesson", "static-slide walkthrough", "RNN mini-lab", "project checklist mini-lab", "exam-style MCQs"],
    resources: {
      ...
      recording: AMLA_DRIVE.projectAudio,
    ...
    aliases: ["12", "l12", "project", "rnn", "lstm", "gan", "transformers"],
