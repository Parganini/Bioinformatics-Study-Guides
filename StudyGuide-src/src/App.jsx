    ...
    en: [
      {
        ...
        options: ["Autapomorphy", "Synapomorphy", "Symplesiomorphy", "Plesiomorphy"],
        answer: 1,
        ...
        optionExplanations: [
          "Autapomorphies are derived traits unique to one taxon. They help diagnose that lineage, but they do not show shared ancestry among multiple taxa.",
          "Synapomorphies are shared and derived. In the lecture, this was stressed as the key evidence used to define clades.",
          "Symplesiomorphies are shared ancestral traits. They can group taxa for the wrong reason because the trait predates the focal clade.",
          "Plesiomorphies are ancestral states. They may be useful context, but they do not by themselves define a specific clade.",
        ],
      },
      {
        kind: "theory",
        question: "Why can a symplesiomorphy be misleading in phylogenetic classification?",
        options: ["Because it is unique to a single taxon", "Because it is shared but ancestral", "Because it is always molecular", "Because it always represents positive selection"],
        answer: 1,
        explanation: "A symplesiomorphy is shared because it was inherited from an older ancestor, not because the taxa form a close clade within the focal comparison.",
        optionExplanations: [
          "A trait unique to a single taxon is closer to an autapomorphy, not a symplesiomorphy.",
          "A shared ancestral trait can make taxa look similar even when that similarity does not identify their closest relationships.",
          "Symplesiomorphies can be morphological, molecular, behavioral or any other character type; the issue is ancestral state, not data type.",
          "Selection is not what defines a symplesiomorphy. The key is that the character state is ancestral relative to the group being studied.",
        ],
      },
      {
        kind: "theory",
        question: "A monophyletic group must include...",
        options: ["only taxa drawn next to each other", "a common ancestor and only some descendants", "the most recent common ancestor and all descendants", "two unrelated lineages with similar traits"],
        answer: 2,
        explanation: "Monophyly means that the group contains the relevant most recent common ancestor and all descendants of that ancestor.",
        optionExplanations: [
          "Tip adjacency is a visual property and can change by rotating nodes; it does not define a clade.",
          "A group containing the ancestor but excluding some descendants is paraphyletic.",
          "This is the definition of a monophyletic group, and the professor emphasized monophyly/paraphyly/polyphyly as exam-relevant core vocabulary.",
          "A group assembled from separate origins is polyphyletic, especially if the MRCA also has descendants outside the proposed group.",
        ],
      },
      {
        kind: "theory",
        question: "What is the main difference between ingroup and outgroup?",
        options: ["The ingroup is the focal clade; the outgroup is outside it and helps root the tree", "The ingroup is always older than the outgroup", "The outgroup is the set of taxa with the shortest branches", "The ingroup contains only ancestors and the outgroup contains only tips"],
        answer: 0,
        explanation: "The ingroup is the focal set of taxa; the outgroup is chosen outside it to help orient or root the tree.",
        optionExplanations: [
          "Correct. The outgroup is part of the experimental design and gives direction to the phylogeny.",
          "Older/younger is not defined simply by being ingroup or outgroup. The distinction is about the focal comparison.",
          "Branch length does not define the outgroup. Outgroups are selected because they are outside the focal clade.",
          "Both ingroups and outgroups are represented by sampled tips; internal ancestors are inferred nodes.",
        ],
      },
      {
        kind: "theory",
        question: "What changes when an internal node is rotated in a phylogenetic tree?",
        options: ["The topology", "The evolutionary relationships", "Only the drawing / order of tips", "The number of substitutions per site"],
        answer: 2,
        explanation: "Rotating an internal node changes the visual arrangement of tips but not the topology or relationships.",
        optionExplanations: [
          "Topology is the branching pattern. A rotation preserves the same branching pattern.",
          "Evolutionary relationships are preserved. This was one of the central tree-reading warnings in the lecture and practical.",
          "Correct. Rotation changes how the tree is drawn, not what it means.",
          "Substitutions per site relate to branch lengths in a phylogram, not to rotating a node.",
        ],
      },
      {
        kind: "theory",
        question: "Which statement correctly distinguishes cladograms, phylograms and chronograms?",
        options: ["All three always show time", "Cladograms show topology only; phylograms scale change; chronograms scale time", "Phylograms have no branch lengths", "Chronograms are always unrooted"],
        answer: 1,
        explanation: "All three convey topology, but branch lengths mean different things: nothing in cladograms, amount of change in phylograms, and time in chronograms.",
        optionExplanations: [
          "Only chronograms explicitly scale branch lengths to time. Cladograms do not use branch length meaning.",
          "Correct. This is the exam-style distinction to remember when a scale bar says substitutions per site versus million years.",
          "Phylograms use branch lengths to represent evolutionary change, such as substitutions per site.",
          "Chronograms are time-scaled trees and are typically rooted because time requires direction from older to newer nodes.",
        ],
      },
      {
        kind: "theory",
        question: "Why are tips and internal nodes not equivalent kinds of evidence?",
        options: ["Tips are sampled observations, while internal nodes are inferred ancestors", "Internal nodes are always directly sequenced", "Tips are always hypothetical", "Internal nodes are only graphical decorations"],
        answer: 0,
        explanation: "The professor stressed that tips usually come from observed/sampled data, whereas internal nodes represent inferred historical ancestors or splits.",
        optionExplanations: [
          "Correct. This is why phylogenetic trees are hypotheses: the past is inferred from present data.",
          "Internal ancestral sequences are generally inferred, not directly observed in normal species trees.",
          "Tips are usually the real sampled units: sequences, species, populations, individuals or OTUs.",
          "Internal nodes are not decorations; they encode inferred ancestors, splits and bipartitions.",
        ],
      },
      {
        kind: "practical",
        question: "In the tree-thinking practical, why do quartets matter?",
        options: ["They are the first unrooted case with alternative resolutions", "They are always easier than triplets", "They remove the need for rooting", "They are only used for drawing labels"],
        answer: 0,
        explanation: "With four taxa, an unrooted tree already has alternative splits such as AB|CD, AC|BD and AD|BC; complexity grows rapidly after that.",
        optionExplanations: [
          "Correct. The practical uses quartets to show why tree space becomes a computational problem very quickly.",
          "Triplets are simpler. The professor described the triplet as the simplest unambiguous case, while quartets introduce ambiguity.",
          "Quartets do not remove rooting issues. Adding a root increases the number of possible interpretations.",
          "Quartets are not just graphics; they are a compact way to reason about possible splits among four taxa.",
        ],
      },
      {
        kind: "practical",
        question: "Which practical interpretation of a polytomy is safest?",
        options: ["It means one lineage is more advanced", "It usually indicates unresolved relationships or a multifurcation", "It proves all descendants evolved at the same rate", "It is the same thing as a long branch"],
        answer: 1,
        explanation: "A polytomy is a node with more than two descendants; in practice it often represents unresolved relationships, although some rapid radiations can be hard polytomies.",
        optionExplanations: [
          "Advanced/lower language is ladder-thinking and should be avoided.",
          "Correct. The practical point is to read it as lack of resolution unless there is a biological reason to treat it as a real rapid multifurcation.",
          "Equal rates are not implied by a polytomy. Rate variation is a separate issue.",
          "A long branch is about branch length; a polytomy is about the number of descendant branches from a node.",
        ],
      },
      {
        kind: "theory",
        question: "Which statement best avoids ladder-thinking?",
        options: ["Lineages near the top are ancestors of those below", "Living taxa can be ranked from primitive to advanced", "Relatedness is about MRCA, not vertical position or complexity", "A bottom taxon is more evolved than a top taxon"],
        answer: 2,
        explanation: "Trees are not ladders: living lineages should not be ranked by visual position, complexity, or imagined superiority.",
        optionExplanations: [
          "Tips are sampled lineages, not ancestors of other tips just because of where they appear on the page.",
          "Primitive/advanced terminology implies scala naturae and is misleading for living lineages.",
          "Correct. MRCA logic and branching pattern are the legitimate basis for comparing relatedness.",
          "Top/bottom placement has no evolutionary meaning. Node rotations can change that placement without changing relationships.",
        ],
      },
    ],
    es: [
      {
        ...
        options: ["Autapomorphy", "Synapomorphy", "Symplesiomorphy", "Plesiomorphy"],
        answer: 1,
        explanation: "Las synapomorphies son caracteres derivados compartidos heredados del ancestro común más reciente; por eso definen clados.",
        optionExplanations: [
          "Las autapomorphies son caracteres derivados únicos de un taxón. Diagnostican ese linaje, pero no muestran ancestría compartida entre varios taxones.",
          "Las synapomorphies son compartidas y derivadas. En la clase, el profesor las remarca como la evidencia clave para definir clados.",
          "Las symplesiomorphies son caracteres ancestrales compartidos. Pueden agrupar taxones por una razón histórica equivocada porque el rasgo precede al clado focal.",
          "Las plesiomorphies son estados ancestrales. Dan contexto, pero no definen por sí solas un clado específico.",
        ],
      },
      {
        kind: "theory",
        question: "¿Por qué una symplesiomorphy puede ser engañosa en clasificación filogenética?",
        options: ["Porque es única de un solo taxón", "Porque es compartida pero ancestral", "Porque siempre es molecular", "Porque siempre representa selección positiva"],
        answer: 1,
        explanation: "Una symplesiomorphy es compartida porque viene de un ancestro más antiguo, no porque los taxones formen un clado cercano dentro de la comparación focal.",
        optionExplanations: [
          "Un rasgo único de un solo taxón corresponde más bien a una autapomorphy, no a una symplesiomorphy.",
          "Un carácter ancestral compartido puede hacer que los taxones parezcan similares aunque esa similitud no identifique sus relaciones más cercanas.",
          "Las symplesiomorphies pueden ser morfológicas, moleculares, conductuales, etc. El problema es el estado ancestral, no el tipo de dato.",
          "La selección no define una symplesiomorphy. Lo importante es que el estado del carácter es ancestral respecto al grupo estudiado.",
        ],
      },
      {
        kind: "theory",
        question: "Un grupo monofilético debe incluir...",
        options: ["solo taxones dibujados uno al lado del otro", "un ancestro común y solo algunos descendientes", "el ancestro común más reciente y todos sus descendientes", "dos linajes no relacionados con rasgos similares"],
        answer: 2,
        explanation: "La monofilia significa que el grupo contiene al ancestro común más reciente relevante y todos sus descendientes.",
        optionExplanations: [
          "La cercanía visual de tips puede cambiar al rotar nodos; no define un clado.",
          "Un grupo que contiene al ancestro pero excluye algunos descendientes es parafilético.",
          "Esta es la definición de grupo monofilético, y el profesor remarcó monofilia/parafilia/polifilia como vocabulario central para examen.",
          "Un grupo armado desde orígenes separados es polifilético, sobre todo si el MRCA también tiene descendientes fuera del grupo propuesto.",
        ],
      },
      {
        kind: "theory",
        question: "¿Cuál es la diferencia principal entre ingroup y outgroup?",
        options: ["El ingroup es el clado focal; el outgroup está fuera y ayuda a enraizar el árbol", "El ingroup siempre es más antiguo que el outgroup", "El outgroup es el conjunto de taxones con ramas más cortas", "El ingroup contiene solo ancestros y el outgroup solo tips"],
        answer: 0,
        explanation: "El ingroup es el conjunto focal de taxones; el outgroup se elige fuera de él para orientar o enraizar el árbol.",
        optionExplanations: [
          "Correcto. El outgroup forma parte del diseño experimental y da dirección a la filogenia.",
          "Ser más antiguo o más reciente no se define simplemente por ser ingroup u outgroup. La distinción depende de la comparación focal.",
          "La longitud de rama no define el outgroup. Se elige porque está fuera del clado focal.",
          "Tanto ingroup como outgroup se representan con tips muestreados; los ancestros internos son inferidos.",
        ],
      },
      {
        kind: "theory",
        question: "¿Qué cambia cuando rotas un nodo interno en un árbol filogenético?",
        options: ["La topología", "Las relaciones evolutivas", "Solo el dibujo / orden de los tips", "El número de sustituciones por sitio"],
        answer: 2,
        explanation: "Rotar un nodo interno cambia la disposición visual de los tips, pero no la topología ni las relaciones.",
        optionExplanations: [
          "La topología es el patrón de ramificación. Una rotación conserva el mismo patrón.",
          "Las relaciones evolutivas se mantienen. Esta fue una de las advertencias centrales de lectura de árboles en clase y práctica.",
          "Correcto. La rotación cambia cómo se dibuja el árbol, no qué significa.",
          "Las sustituciones por sitio se relacionan con longitudes de rama en un filograma, no con rotar un nodo.",
        ],
      },
      {
        kind: "theory",
        question: "¿Qué distingue correctamente cladogramas, filogramas y cronogramas?",
        options: ["Los tres siempre muestran tiempo", "Los cladogramas muestran solo topología; los filogramas escalan cambio; los cronogramas escalan tiempo", "Los filogramas no tienen longitudes de rama", "Los cronogramas siempre son no enraizados"],
        answer: 1,
        explanation: "Los tres transmiten topología, pero las longitudes de rama significan cosas distintas: nada en cladogramas, cantidad de cambio en filogramas y tiempo en cronogramas.",
        optionExplanations: [
          "Solo los cronogramas escalan explícitamente las ramas en tiempo. Los cladogramas no dan significado a la longitud de rama.",
          "Correcto. Esta es la distinción de examen cuando una escala dice sustituciones por sitio versus millones de años.",
          "Los filogramas sí usan longitudes de rama para representar cambio evolutivo, como sustituciones por sitio.",
          "Los cronogramas son árboles escalados en tiempo y normalmente están enraizados porque el tiempo requiere dirección de nodos antiguos a recientes.",
        ],
      },
      {
        kind: "theory",
        question: "¿Por qué tips y nodos internos no son evidencias equivalentes?",
        options: ["Los tips son observaciones muestreadas, mientras los nodos internos son ancestros inferidos", "Los nodos internos siempre se secuencian directamente", "Los tips siempre son hipotéticos", "Los nodos internos son solo decoración gráfica"],
        answer: 0,
        explanation: "El profesor remarcó que los tips suelen venir de datos observados/muestreados, mientras que los nodos internos representan ancestros históricos o splits inferidos.",
        optionExplanations: [
          "Correcto. Por eso los árboles filogenéticos son hipótesis: el pasado se infiere a partir de datos presentes.",
          "Las secuencias ancestrales internas normalmente se infieren; no se observan directamente en árboles de especies.",
          "Los tips suelen ser las unidades reales muestreadas: secuencias, especies, poblaciones, individuos u OTUs.",
          "Los nodos internos no son decoración: codifican ancestros inferidos, splits y biparticiones.",
        ],
      },
      {
        kind: "practical",
        question: "En la práctica de tree thinking, ¿por qué importan los cuartetos?",
        options: ["Son el primer caso no enraizado con resoluciones alternativas", "Siempre son más fáciles que los tripletes", "Eliminan la necesidad de enraizar", "Solo sirven para dibujar etiquetas"],
        answer: 0,
        explanation: "Con cuatro taxones, un árbol no enraizado ya tiene splits alternativos como AB|CD, AC|BD y AD|CB; la complejidad crece rápidamente después.",
        optionExplanations: [
          "Correcto. La práctica usa cuartetos para mostrar por qué el espacio de árboles se vuelve rápidamente un problema computacional.",
          "Los tripletes son más simples. El profesor describió el triplete como el caso no ambiguo más simple, mientras que los cuartetos introducen ambigüedad.",
          "Los cuartetos no eliminan los problemas de enraizamiento. Agregar una raíz aumenta el número de interpretaciones posibles.",
          "Los cuartetos no son solo gráficos; son una forma compacta de razonar sobre posibles splits entre cuatro taxones.",
        ],
      },
      {
        kind: "practical",
        question: "¿Cuál es la interpretación práctica más segura de una politomía?",
        options: ["Significa que un linaje es más avanzado", "Suele indicar relaciones no resueltas o una multifurcación", "Prueba que todos los descendientes evolucionaron a la misma tasa", "Es lo mismo que una rama larga"],
        answer: 1,
        explanation: "Una politomía es un nodo con más de dos descendientes; en la práctica suele representar relaciones no resueltas, aunque algunas radiaciones rápidas pueden ser politomías duras.",
        optionExplanations: [
          "Hablar de más avanzado/inferior es ladder-thinking y debe evitarse.",
          "Correcto. El punto práctico es leerla como falta de resolución salvo que haya razón biológica para tratarla como multifurcación real rápida.",
          "Una politomía no implica tasas iguales. La variación de tasas es otro problema.",
          "Una rama larga se refiere a longitud de rama; una politomía se refiere al número de ramas descendientes desde un nodo.",
        ],
      },
      {
        kind: "theory",
        question: "¿Qué enunciado evita mejor el ladder-thinking?",
        options: ["Los linajes de arriba son ancestros de los de abajo", "Los taxones vivos se pueden ordenar de primitivos a avanzados", "La relación depende del MRCA, no de la posición vertical ni de la complejidad", "Un taxón de abajo está más evolucionado que uno de arriba"],
        answer: 2,
        explanation: "Los árboles no son escaleras: los linajes vivos no deben ordenarse por posición visual, complejidad o supuesta superioridad.",
        optionExplanations: [
          "Los tips son linajes muestreados, no ancestros de otros tips solo por aparecer arriba o abajo en la página.",
          "La terminología primitivo/avanzado implica scala naturae y es engañosa para linajes vivos.",
          "Correcto. La lógica de MRCA y el patrón de ramificación son la base legítima para comparar relaciones.",
          "La posición arriba/abajo no tiene significado evolutivo. Rotar nodos puede cambiar esa posición sin cambiar relaciones.",
        ],
      },
    ],
    fa: [
      {
        kind: "theory",
        question: "کدام نوع کاراکتر قوی‌ترین شواهد برای تعریف یک کلاد است؟",
        options: ["اتاپومورفی", "سیناپومورفی", "سیمپلزیومورفی", "پلزیومورفی"],
        answer: 1,
        explanation: "سیناپومورفی‌ها صفات مشتقِ مشترکی هستند که از نزدیک‌ترین نیای مشترک به ارث رسیده‌اند؛ بنابراین کلادها را تعریف می‌کنند.",
        optionExplanations: [
          "اتاپومورفی صفت مشتقِ منحصر به یک تاکسون است. آن دودمان را تشخیص می‌دهد، اما رابطهٔ مشترک میان چند تاکسون را نشان نمی‌دهد.",
          "سیناپومورفی هم مشترک است و هم مشتق. در کلاس، استاد آن را شواهد کلیدی برای تعریف کلادها دانست.",
          "سیمپلزیومورفی صفت اجدادی مشترک است. چون پیش از کلاد کانونی وجود داشته، می‌تواند گروه‌بندی گمراه‌کننده ایجاد کند.",
          "پلزیومورفی حالت اجدادی است. به‌تنهایی یک کلاد مشخص را تعریف نمی‌کند.",
        ],
      },
      {
        kind: "theory",
        question: "چرا سیمپلزیومورفی می‌تواند در رده‌بندی تبارزایی گمراه‌کننده باشد؟",
        options: ["چون فقط در یک تاکسون وجود دارد", "چون مشترک ولی اجدادی است", "چون همیشه مولکولی است", "چون همیشه نشان‌دهندهٔ انتخاب مثبت است"],
        answer: 1,
        explanation: "سیمپلزیومورفی به این دلیل مشترک است که از نیای قدیمی‌تر آمده، نه به این دلیل که تاکسون‌ها در مقایسهٔ کانونی یک کلاد نزدیک می‌سازند.",
        optionExplanations: [
          "صفت منحصر به یک تاکسون بیشتر اتاپومورفی است، نه سیمپلزیومورفی.",
          "صفت اجدادی مشترک می‌تواند تاکسون‌ها را شبیه نشان دهد، بدون اینکه نزدیک‌ترین رابطهٔ آن‌ها را مشخص کند.",
          "سیمپلزیومورفی می‌تواند ریختی، مولکولی، رفتاری و غیره باشد؛ مسئله نوع داده نیست، اجدادی‌بودن صفت است.",
          "انتخاب، سیمپلزیومورفی را تعریف نمی‌کند؛ نکته این است که حالت صفت نسبت به گروه مورد مطالعه اجدادی است.",
        ],
      },
      {
        kind: "theory",
        question: "یک گروه تک‌تبار باید شامل چه چیزی باشد؟",
        options: ["فقط تاکسون‌هایی که کنار هم رسم شده‌اند", "یک نیای مشترک و فقط برخی نوادگان", "نزدیک‌ترین نیای مشترک و همهٔ نوادگان", "دو دودمان نامرتبط با صفات مشابه"],
        answer: 2,
        explanation: "تک‌تبارگی یعنی گروه شامل نزدیک‌ترین نیای مشترک مربوطه و همهٔ نوادگان آن باشد.",
        optionExplanations: [
          "کنار هم بودن نوک‌ها ویژگی تصویری است و با چرخاندن گره‌ها تغییر می‌کند؛ کلاد را تعریف نمی‌کند.",
          "گروهی که نیا را دارد ولی برخی نوادگان را حذف می‌کند، پیراتبار است.",
          "این تعریف گروه تک‌تبار است و استاد سه‌گانهٔ تک‌تبار/پیراتبار/چندتبار را واژگان اصلی امتحانی دانست.",
          "گروهی که از منشأهای جدا جمع شده باشد چندتبار است، به‌ویژه اگر MRCA نوادگانی بیرون از گروه پیشنهادی داشته باشد.",
        ],
      },
      {
        kind: "theory",
        question: "تفاوت اصلی درون‌گروه و برون‌گروه چیست؟",
        options: ["درون‌گروه کلاد کانونی است؛ برون‌گروه بیرون از آن است و به ریشه‌گذاری کمک می‌کند", "درون‌گروه همیشه قدیمی‌تر از برون‌گروه است", "برون‌گروه تاکسون‌هایی با کوتاه‌ترین شاخه‌هاست", "درون‌گروه فقط نیاها و برون‌گروه فقط نوک‌ها را دارد"],
        answer: 0,
        explanation: "درون‌گروه مجموعهٔ کانونی تاکسون‌هاست؛ برون‌گروه بیرون از آن انتخاب می‌شود تا جهت و ریشهٔ درخت مشخص شود.",
        optionExplanations: [
          "درست است. برون‌گروه بخشی از طراحی تحلیل است و به تبارزایی جهت می‌دهد.",
          "قدیمی‌تر یا جدیدتر بودن با درون‌گروه/برون‌گروه تعریف نمی‌شود؛ این تمایز به مقایسهٔ کانونی مربوط است.",
          "طول شاخه برون‌گروه را تعریف نمی‌کند. برون‌گروه چون خارج از کلاد کانونی است انتخاب می‌شود.",
          "هم درون‌گروه و هم برون‌گروه با نوک‌های نمونه‌برداری‌شده نمایش داده می‌شوند؛ نیاهای داخلی استنباطی‌اند.",
        ],
      },
      {
        kind: "theory",
        question: "چرخاندن یک گرهٔ داخلی در درخت تبارزایی چه چیزی را تغییر می‌دهد؟",
        options: ["توپولوژی", "روابط تکاملی", "فقط شکل رسم / ترتیب نوک‌ها", "تعداد جانشینی در هر سایت"],
        answer: 2,
        explanation: "چرخاندن گرهٔ داخلی چیدمان دیداری نوک‌ها را عوض می‌کند، اما توپولوژی و روابط را تغییر نمی‌دهد.",
        optionExplanations: [
          "توپولوژی همان الگوی انشعاب است. چرخش همان الگو را حفظ می‌کند.",
          "روابط تکاملی حفظ می‌شوند. این یکی از هشدارهای اصلی کلاس و تمرین بود.",
          "درست است. چرخش فقط شکل رسم را عوض می‌کند، نه معنای درخت را.",
          "جانشینی در هر سایت به طول شاخه در فیلوگرام مربوط است، نه به چرخاندن گره.",
        ],
      },
      {
        kind: "theory",
        question: "کدام گزینه کلادوگرام، فیلوگرام و کرونوگرام را درست تفکیک می‌کند؟",
        options: ["هر سه همیشه زمان را نشان می‌دهند", "کلادوگرام فقط توپولوژی را نشان می‌دهد؛ فیلوگرام تغییر را مقیاس می‌کند؛ کرونوگرام زمان را مقیاس می‌کند", "فیلوگرام طول شاخه ندارد", "کرونوگرام همیشه بدون ریشه است"],
        answer: 1,
        explanation: "هر سه توپولوژی را نشان می‌دهند، اما طول شاخه‌ها معنای متفاوتی دارد: در کلادوگرام هیچ، در فیلوگرام مقدار تغییر، و در کرونوگرام زمان.",
        optionExplanations: [
          "فقط کرونوگرام طول شاخه را به زمان مقیاس می‌کند. کلادوگرام به طول شاخه معنا نمی‌دهد.",
          "درست است. این تمایز برای امتحان مهم است، مخصوصاً وقتی مقیاس نوشته شده باشد: جانشینی در هر سایت یا میلیون سال.",
          "فیلوگرام از طول شاخه برای نمایش تغییر تکاملی مثل جانشینی در هر سایت استفاده می‌کند.",
          "کرونوگرام درخت زمان‌مقیاس است و معمولاً ریشه‌دار است چون زمان جهت قدیم به جدید لازم دارد.",
        ],
      },
      {
        kind: "theory",
        question: "چرا نوک‌ها و گره‌های داخلی شواهد هم‌ارز نیستند؟",
        options: ["نوک‌ها مشاهده‌های نمونه‌برداری‌شده‌اند، اما گره‌های داخلی نیاهای استنباطی‌اند", "گره‌های داخلی همیشه مستقیماً توالی‌یابی می‌شوند", "نوک‌ها همیشه فرضی‌اند", "گره‌های داخلی فقط تزئین تصویری‌اند"],
        answer: 0,
        explanation: "استاد تأکید کرد که نوک‌ها معمولاً از دادهٔ مشاهده‌شده می‌آیند، در حالی که گره‌های داخلی نیاها یا شکاف‌های تاریخی استنباطی‌اند.",
        optionExplanations: [
          "درست است. به همین دلیل درخت‌های تبارزایی فرضیه‌اند: گذشته از داده‌های حاضر استنباط می‌شود.",
          "توالی‌های اجدادی داخلی معمولاً استنباط می‌شوند و در درخت‌های گونه‌ای مستقیماً مشاهده نمی‌شوند.",
          "نوک‌ها معمولاً واحدهای واقعی نمونه‌برداری‌شده‌اند: توالی‌ها، گونه‌ها، جمعیت‌ها، افراد یا OTUها.",
          "گره‌های داخلی تزئین نیستند؛ آن‌ها نیاهای استنباطی، شکاف‌ها و دوپارگی‌ها را نشان می‌دهند.",
        ],
      },
      {
        kind: "practical",
        question: "در تمرین تفکر درختی، چرا کوارتت‌ها مهم‌اند؟",
        options: ["اولین حالت بدون ریشه با پاسخ‌های جایگزین‌اند", "همیشه از تریپلت‌ها آسان‌ترند", "نیاز به ریشه‌گذاری را حذف می‌کنند", "فقط برای رسم برچسب‌ها هستند"],
        answer: 0,
        explanation: "با چهار تاکسون، یک درخت بدون ریشه از قبل شکاف‌های جایگزین مثل AB|CD، AC|BD و AD|CB دارد؛ پس پیچیدگی به‌سرعت رشد می‌کند.",
        optionExplanations: [
          "درست است. تمرین از کوارتت‌ها برای نشان‌دادن رشد سریع فضای درخت‌ها و مسئلهٔ محاسباتی استفاده می‌کند.",
          "تریپلت‌ها ساده‌ترند. استاد تریپلت را ساده‌ترین حالت بی‌ابهام و کوارتت را آغاز ابهام معرفی کرد.",
          "کوارتت‌ها مسئلهٔ ریشه‌گذاری را حذف نمی‌کنند. افزودن ریشه تعداد تفسیرهای ممکن را بیشتر می‌کند.",
          "کوارتت‌ها فقط تصویر نیستند؛ راهی فشرده برای فکرکردن دربارهٔ شکاف‌های ممکن میان چهار تاکسون‌اند.",
        ],
      },
      {
        kind: "practical",
        question: "امن‌ترین تفسیر عملی از یک پلی‌تومی چیست؟",
        options: ["یعنی یک دودمان پیشرفته‌تر است", "معمولاً رابطه‌های حل‌نشده یا چندشاخه‌شدن را نشان می‌دهد", "ثابت می‌کند همهٔ نوادگان با نرخ یکسان تکامل یافته‌اند", "همان شاخهٔ بلند است"],
        answer: 1,
        explanation: "پلی‌تومی گرهی با بیش از دو شاخهٔ نواده است؛ در عمل اغلب رابطهٔ حل‌نشده را نشان می‌دهد، هرچند برخی تابش‌های سریع می‌توانند پلی‌تومی سخت باشند.",
        optionExplanations: [
          "زبان پیشرفته/پایین‌تر همان تفکر نردبانی است و باید پرهیز شود.",
          "درست است. نکتهٔ عملی این است که آن را فقدان وضوح بخوانیم، مگر اینکه دلیل زیستی برای چندشاخه‌شدن واقعی سریع وجود داشته باشد.",
          "پلی‌تومی نرخ‌های برابر را نتیجه نمی‌دهد. تغییر نرخ مسئلهٔ جداگانه‌ای است.",
          "شاخهٔ بلند دربارهٔ طول شاخه است؛ پلی‌تومی دربارهٔ تعداد شاخه‌های خروجی از یک گره است.",
        ],
      },
      {
        kind: "theory",
        question: "کدام گزاره بهتر از تفکر نردبانی دوری می‌کند؟",
        options: ["دودمان‌های بالای شکل نیای دودمان‌های پایین‌اند", "تاکسون‌های زنده را می‌توان از ابتدایی تا پیشرفته رتبه‌بندی کرد", "رابطه به MRCA بستگی دارد، نه جایگاه عمودی یا پیچیدگی", "تاکسون پایین‌تر تکامل‌یافته‌تر از تاکسون بالاتر است"],
        answer: 2,
        explanation: "درخت‌ها نردبان نیستند: دودمان‌های زنده را نباید بر اساس جایگاه تصویری، پیچیدگی یا برتری فرضی رتبه‌بندی کرد.",
        optionExplanations: [
          "نوک‌ها دودمان‌های نمونه‌برداری‌شده‌اند، نه نیاهای نوک‌های دیگر صرفاً به‌دلیل جایگاه در صفحه.",
          "اصطلاح ابتدایی/پیشرفته همان scala naturae را القا می‌کند و برای دودمان‌های زنده گمراه‌کننده است.",
          "درست است. منطق MRCA و الگوی انشعاب مبنای معتبر مقایسهٔ خویشاوندی‌اند.",
          "بالا/پایین معنای تکاملی ندارد. چرخاندن گره‌ها می‌تواند جایگاه را عوض کند بدون اینکه رابطه تغییر کند.",
        ],
      },
    ],
  },
