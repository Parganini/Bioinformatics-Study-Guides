...
export const LB1_LESSONS = [
  ...
  },
  {
    ...
    products: ["study targets", "exam prompts", "common traps"],
    lessonType: "planned source route",
  ...
  },
  {
    ...
    products: ["workflow checklist", "exam prompts", "common traps"],
    lessonType: "planned source route",
  ...
  },
  {
    ...
    products: ["project checklist", "notebook links", "exam prompts"],
    lessonType: "planned project route",
    resources: {
